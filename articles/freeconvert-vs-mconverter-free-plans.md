...
![Searching Google for: is FreeConvert free?](freeconvert-google-search.webp)
...
![FreeConvert’s home page with plenty of ads](freeconvert-homepage.webp)
...
![FreeConvert stopped after 10 files](freeconvert-10-files-limit.webp)
...
![FreeConvert responding to a negative review](freeconvert-free-response.webp)
...
If you’re curious, read more about [MConverter’s free plan improvements](https://mconverter.eu/blog/improved-free-plan/).
...
![FreeConvert batch conversion limit](freeconvert-batch-limit.webp)
...
![Batch-converting with MConverter](mconverter-batch-converting.webp)
...
## Size Limit & Max Conversion Time
...
![Ad-blocker detected on FreeConvert](freeconvert-adblock-detected-wall.webp)
...
![FreeConvert ad-blocker negative review](freeconvert-adblocker-review.webp)
...
If you need more information to determine whether FreeConvert is a safe choice for you, see our [in-depth article about its safety](https://mconverter.eu/blog/is-freeconvert-safe/).
...
![MConverter privacy and security practices](mconverter-privacy-security.webp)
...
![FreeConvert gives no refunds](freeconvert-refund-terms.webp)
...
<table id="tblComparison">
    ...
    <tr>
        ...
        <td>Permitted, but shows a notice</td>
    </tr>
    <tr>
        <th>Safety</th>
        <td>Mostly safe</td>
        <td>Safe with certified data centres</td>
    </tr>
    <tr>
        <th>Refunds</th>
        <td>No refunds</td>
        <td>Refunds offered</td>
    </tr>
</table>
<style>
#tblComparison {
